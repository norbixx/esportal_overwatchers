...
<head>
    ...
    <title>Esportal OV Panel - Moje zgłoszenia</title>
    ...
    <div id="con-rep">
            <?php
                if(!isset($_COOKIE['auth_token']) && !isset($_COOKIE['auth_login'])){
                    ...
                    <h1>Moje aktualne zgłoszenia</h1><br />
                    ";
                    if($permission == 2){
                    ...
                    echo 
                        "
                        <a href='myreport.php'><button class='buttonDark active'><i class='fa fa-flag'></i> Moje aktualne zgłoszenia</button></a>
                    ...
                    if($flag == 1){
                        ...
                        $countQuery = "select count(*) as count from replays where ban=100 and repadmin='".$login."'";
                        ...
                        $replayQuery = "select id, repuser, report, repdate from replays where ban=100 and repadmin='".$login."' LIMIT ".($page-1)*$limit.",".$limit;
                    ...
                    if($page > 1)
                            echo "<a href='myreport.php?page=".($page-1)."'><button class='buttonDark'><i class='fas fa-angle-left'></i></button></a>
                            ";
                        else
                            ...
                            for($k = 1; $k < $site + 1; $k++){
                                ...
                                if($k == $page)
                                    echo "<a href='myreport.php?page=".$k."'><button class='buttonDark active'>".$k."</button></a>";
                                else
                                    echo "<a href='myreport.php?page=".$k."'><button class='buttonDark'>".$k."</button></a>";
                            }
                            ...
                            echo "
                            <a href='myreport.php?page=".($page+1)."'><button class='buttonDark'><i class='fas fa-angle-right'></i></button></a>";
