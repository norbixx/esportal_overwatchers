            ...
            <?php
                if(!isset($_COOKIE['auth_token']) && !isset($_COOKIE['auth_login'])){
                    ...
                    if($permission == 1){
                        ...
                        <a href='history.php'><button class='buttonDark active'><i class='fa fa-history'></i> Historia zgłoszeń</button></a>
                    ...
                    if($flag == 1){
                        ...
                        $countQuery = "select count(*) as count from replays where done=1";
                        ...
                        $replayQuery = "select id, link, repuser, report, repadmin, ban, description, replink, done, repdate, archivedate, archiveuser from replays where done=1 order by archivedate desc LIMIT ".($page-1)*$limit.",".$limit;
                        ...
                        if(mysqli_num_rows($replayDoQuery)){
                            while($replayScore = mysqli_fetch_array($replayDoQuery)){
                                ...
                                echo "
                                <tr>
                                    <td><a href='".$replayScore['link']."'>DEMO</a></td>
                    ...
                    if($page > 1)
                        echo "<a href='history.php?page=".($page-1)."'><button class='buttonDark'><i class='fas fa-angle-left'></i></button></a>
                        ";
                    else
                        ...
                        for($k = 1; $k < $site + 1; $k++){
                            ...
                            if($k == $page)
                                echo "<a href='history.php?page=".$k."'><button class='buttonDark active'>".$k."</button></a>";
                            else
                                echo "<a href='history.php?page=".$k."'><button class='buttonDark'>".$k."</button></a>";
                        }
                        ...
                        echo "
                        <a href='history.php?page=".($page+1)."'><button class='buttonDark'><i class='fas fa-angle-right'></i></button></a>";     
